...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		conversationLogRoute.GET("/", middleware.AdminAuth(), controller.GetAllConversationLogs)
		conversationLogRoute.GET("/self", middleware.UserAuth(), controller.GetUserConversationLogs)
