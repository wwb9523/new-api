...
func InitOptionMap() {
	...
	common.OptionMap["ConversationLogEnabled"] = strconv.FormatBool(common.ConversationLogEnabled)
	common.OptionMap["ConversationLogMaxBodyBytes"] = strconv.Itoa(common.ConversationLogMaxBodyBytes)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "ConversationLogEnabled":
			common.ConversationLogEnabled = boolValue
	...
	case "ConversationLogMaxBodyBytes":
		common.ConversationLogMaxBodyBytes, _ = strconv.Atoi(value)
