...
func OaiResponsesToChatHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	service.SetConversationResponseBody(c, info, service.ConversationResponseTextFromResponsesResponse(&responsesResp))
...
func OaiResponsesToChatBufferedStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	service.SetConversationResponseBody(c, info, service.ConversationResponseTextFromResponsesResponse(finalResponse))
...
func OaiResponsesToChatStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	service.SetConversationResponseBody(c, info, state.UsageText())
