...
export const getAllConversationLogs = (
  params: GetConversationLogsParams = {}
) => fetchLogs('/api/conversation-log', params, true)

export const getUserConversationLogs = (
  params: Omit<GetConversationLogsParams, 'username' | 'channel'> = {}
) => fetchLogs('/api/conversation-log', params, false)
