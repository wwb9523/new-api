...
export function buildSearchParams(
  ...
  switch (logCategory) {
    ...
    case 'conversation': {
      const conversationFilters = filters as ConversationLogFilters
      return {
        ...baseParams,
        ...(conversationFilters.model && { model: conversationFilters.model }),
        ...(conversationFilters.token && { token: conversationFilters.token }),
        ...(conversationFilters.group && { group: conversationFilters.group }),
        ...(conversationFilters.username && {
          username: conversationFilters.username,
        }),
        ...(conversationFilters.requestId && {
          requestId: conversationFilters.requestId,
        }),
